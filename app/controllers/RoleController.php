...
class RoleController extends \BaseController {
    ...
    public function index()
    {
        ...
        $roles = Role::where('fk_empresa', '<>', '')->orderBy('name')->get();

        foreach ($roles as $role) {
            try {
                $role->company_name = Company::where('row_id', '=', $role->fk_empresa)->first()->company_name;
            } catch (Exception $e) {
                $role->company_name = '';
            }
        }
    ...
    public function update($id)
    {
        ...
        $existCount = Role::where('fk_empresa', '=', $existRole->fk_empresa)
                             ->where('name', '=', Input::get('name'))
                             ->where('id', '<>', $id)
                             ->count();
