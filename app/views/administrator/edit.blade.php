...
@section('content')
		...
		{{ Form::model($user, array('route' => array('user.update', $user->row_id), 'method' => 'PUT')) }}
		...
		<div class="col-lg-4">
			...
			<div class="form-group  @if ($errors->has('fk_empresa')) has-error @endif">
				...
				{{ Form::select('fk_empresa', $userCompaniesDropdown, $user->fk_empresa, array('class'=>'form-control')) }}
		...
		<div class="col-lg-4">
			...
			<div class="form-group">
				<label>System Admin</label>
				 {{ Form::text('',  '(Pending to decide - to only allow ImagingXpert users?)', array('class'=>'form-control', 'disabled'=>'disabled')) }}
			</div>
				
		   <div class="form-group pull-left">
					
					<a class="btn btn-sm btn-info" href="{{ URL::to('user/'. $user->row_id ) }}"> Cancel</a>
			</div>
