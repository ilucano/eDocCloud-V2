...
@section('content')
    ...
    <div class="modal-header">
        <h3 class="modal-title">{{ $company->company_name }} <small>{{ Helpers::bytesToGigabytes($company->todate_data_usage) }}</small></h3> 
    </div>
    ...
    <div class="modal-footer">
        <a href="{{ URL::to('reports/datausage') }}" class="btn btn-primary"> Back</a>
    </div>
