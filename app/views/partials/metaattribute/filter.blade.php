<div class="row">
    ...
    @foreach ($attributeSets as $attribute)
        ...
        ?>
                ...
                {{ Form::text($attribute->id, Input::get($attribute->id), array('class' => 'form-control')) }}
        <?php
                break;
        ...
        ?>      
                <label for="{{ $attribute->id }}">{{ $attribute->name }}</label>
                {{ Form::select($attribute->id, $dropDown, Input::get($attribute->id), array('class'=>'form-control')) }}
        ...
        ?>
                ...
                @foreach ($attribute->attribute_options as $option)
                    <?php 
                        $checked  =  ( $option->id == Input::get($attribute->id)) ? true: false;
                    ?>
                    <div class="radio">
                        <label>
