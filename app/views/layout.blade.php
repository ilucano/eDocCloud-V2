			...
			<ul class="nav navbar-left top-nav">
				...
				<li class="dropdown">
				    ...
				    <ul class="dropdown-menu">
					    @if(Auth::User()->can('admin_user') || Auth::User()->isOnlyCompanyAdmin() || Auth::User()->isAdmin() || Auth::User()->isCompanyAdmin())
                        <li>
                            <a href="{{ URL::to('companyadmin/user') }}"><i class="fa fa-fw fa-user"></i> My Users</a>
                        </li>
						@endif
						 @if(Auth::User()->can('admin_role') || Auth::User()->isOnlyCompanyAdmin() || Auth::User()->isAdmin()  || Auth::User()->isCompanyAdmin())
						<li>
